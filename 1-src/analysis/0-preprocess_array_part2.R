# Copyright (c) 2023 James E. Barrett, Charlotte D. Vavourakis. Licensed under the MIT license (see LICENSE.md).
...
# To continue the pipeline after preprocessing, 
# recommendation is to save the clean beta matrices as follows:

# Repeatability set
# saveRDS(beta_merged, file="/0-data/beta/beta_repeatability.Rds")

# 3C Discovery set 
# saveRDS(beta_merged, file="/0-data/beta/beta_3CDisc.Rds")

# 3C External validation
# saveRDS(beta_merged, file="/0-data/beta/beta_3CExtVal.Rds")
...
# enter path to flagged-probes folder, in this repository given in /0-data/flagged_probes/
