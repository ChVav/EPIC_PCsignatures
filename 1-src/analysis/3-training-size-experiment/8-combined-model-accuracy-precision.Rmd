...
* Training set: Framingham Heart study (450K), 2639 peripheral blood samples, age range: 23.7-75 (GSE55763; missing values imputed)
* External validation accuracy: Hannum subset same age range (450K), 479 blood samples (GSE40279)
* Validation repeatability: technical reps from FHS, 2x36 blood samples (missing values imputed)
