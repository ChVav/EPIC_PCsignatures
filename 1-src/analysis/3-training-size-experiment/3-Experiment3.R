...
saveRDS(sampleList2, file="./3-output/sampleListloop2.Rds") # fix list to repeat
...
for (j in 1:length(sampleList)){
  ...
  saveRDS(out.df, file="./3-output/results_training_size.Rds") # overwrite results at end of each loop # save temporary results for lasso/elnet
}